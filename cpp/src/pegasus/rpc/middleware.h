...
using CallHeaders = std::unordered_multimap<arrow::util::string_view, arrow::util::string_view>;

/// \brief A write-only wrapper around headers for an RPC call.
class PEGASUS_RPC_EXPORT AddCallHeaders {
 public:
...
struct PEGASUS_RPC_EXPORT CallInfo {
 public:
