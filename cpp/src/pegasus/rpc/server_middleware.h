...
class PEGASUS_RPC_EXPORT ServerMiddleware {
 public:
  ...
  virtual void CallCompleted(const arrow::Status& status) = 0;
};
...
class PEGASUS_RPC_EXPORT ServerMiddlewareFactory {
 public:
  ...
  virtual arrow::Status StartCall(const CallInfo& info, const CallHeaders& incoming_headers,
