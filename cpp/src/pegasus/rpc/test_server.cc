...
std::unique_ptr<pegasus::rpc::FlightServerBase> g_server;

int main(int argc, char** argv) {
  gflags::ParseCommandLineFlags(&argc, &argv, true);

  g_server = pegasus::rpc::ExampleTestServer();

  pegasus::rpc::Location location;
  ARROW_CHECK_OK(pegasus::rpc::Location::ForGrpcTcp("0.0.0.0", FLAGS_port, &location));
