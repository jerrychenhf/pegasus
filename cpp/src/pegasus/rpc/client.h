...
class PEGASUS_RPC_EXPORT FlightCallOptions {
 public:
...
class PEGASUS_RPC_EXPORT FlightClientOptions {
 public:
...
class PEGASUS_RPC_EXPORT FlightStreamWriter : public arrow::ipc::RecordBatchWriter {
 public:
  virtual Status WriteWithMetadata(const arrow::RecordBatch& batch,
                                   std::shared_ptr<arrow::Buffer> app_metadata) = 0;
...
class PEGASUS_RPC_EXPORT FlightClient {
 public:
  ...
  Status DoPut(const FlightDescriptor& descriptor, const std::shared_ptr<arrow::Schema>& schema,
               std::unique_ptr<FlightStreamWriter>* stream,
               std::unique_ptr<FlightMetadataReader>* reader) {
