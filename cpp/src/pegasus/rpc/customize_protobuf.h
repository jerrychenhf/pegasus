...
class SerializationTraits<
    T, typename std::enable_if<
           ...
           !std::is_same<pegasus::rpc::protocol::FlightData, T>::value>::type> {
 public:
...
class SerializationTraits<T, typename std::enable_if<std::is_same<
                                 pegasus::rpc::protocol::FlightData, T>::value>::type> {
 public:
  ...
  static Status Serialize(const grpc::protobuf::Message& msg, ByteBuffer* bb,
                          bool* own_buffer) {
    return pegasus::rpc::internal::FlightDataSerialize(
        *reinterpret_cast<const pegasus::rpc::FlightPayload*>(&msg), bb, own_buffer);
  }

  static Status Deserialize(ByteBuffer* buffer, grpc::protobuf::Message* msg) {
    return pegasus::rpc::internal::FlightDataDeserialize(
        buffer, reinterpret_cast<pegasus::rpc::internal::FlightData*>(msg));
  }
};
