...
inline Atomic32 NoBarrier_AtomicIncrement(volatile Atomic32* ptr,
  ...
  return pegasus::ArithmeticUtil::AsUnsigned<std::plus>(temp, increment);
}
...
inline Atomic64 NoBarrier_AtomicIncrement(volatile Atomic64* ptr,
  ...
  do {
    old_val = *ptr;
    new_val = pegasus::ArithmeticUtil::AsUnsigned<std::plus>(old_val, increment);
  } while (__sync_val_compare_and_swap(ptr, old_val, new_val) != old_val);

  return pegasus::ArithmeticUtil::AsUnsigned<std::plus>(old_val, increment);
}
