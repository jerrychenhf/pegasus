...
public class FlightTestUtil {
  ...
  public static final String TEST_DATA_ENV_VAR = "PEGASUS_TEST_DATA";
  public static final String TEST_DATA_PROPERTY = "pegasus.test.dataRoot";
  ...
  static Path getFlightTestDataRoot() {
    return getTestDataRoot().resolve("rpc");
  }
