...
import org.apache.pegasus.rpc.FlightProducer.ServerStreamListener;
import org.apache.pegasus.rpc.FlightServerMiddleware.Key;
import org.apache.pegasus.rpc.auth.AuthConstants;
import org.apache.pegasus.rpc.auth.ServerAuthHandler;
import org.apache.pegasus.rpc.auth.ServerAuthWrapper;
import org.apache.pegasus.rpc.grpc.ContextPropagatingExecutorService;
import org.apache.pegasus.rpc.grpc.ServerInterceptorAdapter;
import org.apache.pegasus.rpc.grpc.StatusUtils;
import org.apache.pegasus.rpc.impl.Flight;
import org.apache.pegasus.rpc.impl.FlightServiceGrpc.FlightServiceImplBase;
...
class FlightService extends FlightServiceImplBase {
  ...
  public void listActions(Flight.Empty request, StreamObserver<Flight.ActionType> responseObserver) {
    final StreamPipe<org.apache.pegasus.rpc.ActionType, Flight.ActionType> listener = StreamPipe
