...
import org.apache.spark.util.collection.PegasusWritablePartitionedPairCollection._
...
/**
  ...
  */
private[spark] class PegasusPartitionedPairBuffer[K, V](initialCapacity: Int = 64)
    extends PegasusWritablePartitionedPairCollection[K, V] with SizeTracker
{
  import PegasusPartitionedPairBuffer._
...
private object PegasusPartitionedPairBuffer {
